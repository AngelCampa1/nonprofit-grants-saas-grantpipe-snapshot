...
import { Route } from "./radar";

describe("/_authenticated/radar redirect shim", () => {
  it("redirects permanently to /deadlines", () => {
    ...
    expect(hoisted.mockRedirect).toHaveBeenCalledWith({ to: "/deadlines", replace: true });
    expect(thrown).toEqual({ to: "/deadlines", replace: true });
  });
});
