...
description: "Louisville nonprofits need donor, grant, restricted fund, and compliance records in one place when Jefferson County, state, foundation, and federal pass-through awards overlap."
seoTitle: "Nonprofit grant software for Louisville"
seoDescription: "Louisville nonprofits need donor, grant, restricted fund, and compliance records in one place when Jefferson County, state, foundation, and federal."
targetKeyword: "nonprofit software louisville"
...
schema: "Article"
bluf: "Louisville nonprofits usually outgrow separate donor, grant, and finance spreadsheets when local grants, state renewals, and federal pass-through reporting collide in the same quarter."
relatedPages:
  - "/nonprofit-software/kentucky"
...
stateCode: "KY"
stateSlug: "kentucky"
metroAreaName: "Jefferson County"
topFunders:
  - name: "Community Foundation of Louisville"
    type: "community-foundation"
  - name: "Metro United Way"
    type: "united-way"
  - name: "James Graham Brown Foundation"
    type: "government"
  - name: "Owsley Brown II Family Foundation"
    type: "private-foundation"
  - name: "Louisville Metro Government grants"
    type: "private-foundation"
localRegulations:
  - heading: "Kentucky Secretary of State registration and annual filing"
    content: "Kentucky nonprofits should verify charitable registration, annual report, and solicitation filing rules with Kentucky Secretary of State. Keep these deadlines next to grant reports rather than in a separate compliance spreadsheet."
    variant: "warning"
  - heading: "Uniform Guidance for federal pass-throughs"
    ...
    variant: "info"
fiscalCalendarNotes: "Louisville, Jefferson County, Kentucky, and federal funders can use different fiscal calendars. Store the award calendar on the grant record so reporting dates do not depend on staff memory."
registrationNotes: "Check Kentucky Secretary of State guidance before soliciting or renewing registrations in Kentucky. Organizations with multistate donors should also track foreign registration obligations."
faqs:
  - q: "What software issue creates the most risk for Louisville nonprofits?"
  ...
  - q: "Which local funders should Louisville nonprofits track first?"
    a: "Start with Community Foundation of Louisville, Metro United Way, James Graham Brown Foundation, then add county, state, and federal pass-through programs that match your service line."
...
pricingStats:
  - stat: "Louisville nonprofits commonly manage at least five local funding channels: Community Foundation of Louisville, Metro United Way, James Graham Brown Foundation, Owsley Brown II Family Foundation, Louisville Metro Government grants."
  ...
  - stat: "Louisville nonprofits receiving CDBG, HOME, ESG, HHS, DOJ, or workforce pass-through funds should preserve award terms, budget revisions, procurement records, and report submissions in the grant file."
    source: "HUD Exchange and Uniform Guidance"
    sourceUrl: "https://www.hudexchange.info/programs/cdbg-entitlement/"
---

## Why Louisville needs a connected grant record

A mid-sized Louisville nonprofit can have a county human services contract, a state pass-through award, two foundation grants, and individual donors restricted to the same program. If those records live in different systems, the first clean report is usually the one built for the auditor. That is too late.
...
## Reporting workflow for Louisville teams
...
The strongest Louisville grant files are built before award. They contain the prospect note, the proposal, the budget basis, the restriction setup, the funder contact, and a plain-language explanation of what the report will need. That makes the eventual award easier to accept and easier to close.

For state context, see the [Kentucky nonprofit software page](/nonprofit-software/kentucky). For the compliance mechanics behind pass-through grants, use the [grant compliance 101 guide](/resources/guides/grant-compliance-101-for-nonprofits).
