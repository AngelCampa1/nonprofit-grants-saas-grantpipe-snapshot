...
description: "10 active foundations funding nonprofits in the New England, with focus areas, grant ranges, and application cycles."
seoTitle: "Top Foundation Grants New England 2026"
seoDescription: "10 foundations funding New England nonprofits in 2026: focus areas, eligibility, grant ranges, application cycles, and official URLs."
targetKeyword: "foundation grants new england"
...
schema: "ItemList"
category: "Foundation Grants"
qualifier: "New England 2026"
targetPersona:
  - "executive-director"
...
tools:
  - name: "The Boston Foundation"
    summary: "Greater Boston - education, jobs, health, housing, arts, civic engagement"
    pros:
  ...
  - name: "Cummings Foundation"
    summary: "Greater Boston - social services, education, healthcare"
    pros:
  ...
  - name: "Klarman Family Foundation"
    summary: "Boston Jewish community, biomedical research, mental health, education"
    pros:
  ...
  - name: "Barr Foundation"
    summary: "New England - arts, climate, education"
    pros:
  ...
  - name: "Liberty Mutual Foundation"
    summary: "Homelessness, education, youth services in MA and Northeast"
    pros:
  ...
  - name: "The New York Community Trust"
    summary: "NYC and surrounding region - children, education, environment, health, arts"
    pros:
  ...
  - name: "Carnegie Corporation of New York"
    summary: "Education, democracy, international peace, higher education access"
    pros:
  ...
  - name: "Ford Foundation"
    summary: "Social justice, civic engagement, gender and racial equity, internet freedom"
    pros:
  ...
  - name: "The Rockefeller Foundation"
    summary: "Health, food, climate, power, innovative finance"
    pros:
  ...
  - name: "The Pew Charitable Trusts"
    summary: "Public policy, conservation, health, civic life - Philadelphia regional grants"
    pros:
...
faqs:
  ...
  - q: "How should a nonprofit track multiple concurrent foundation grants?"
    a: "A grants management system with restricted fund accounting, deadline calendars, and expenditure documentation per award is the operational baseline. Spreadsheets work for organizations with one or two grants but break down at three or more concurrent awards because reconciling restricted balances across funders, programs, and fiscal periods becomes manual and error-prone. GrantPipe is built for this multi-funder workflow at the $500K-$10M budget range."
answers:
  - question: "What are the largest foundations giving in the New England?"
    answer: "The largest foundations active in the New England include The Boston Foundation, Cummings Foundation, Klarman Family Foundation. Grant size depends on alignment with the foundation's published focus areas, not just the foundation's total assets - a smaller community foundation may award more relevant funding to an aligned local nonprofit than a large national foundation."
  - question: "Do these foundations fund nonprofits outside the New England?"
    answer: "Some do, some do not. Funders like Ford, Rockefeller, and Carnegie Corporation operate nationally and internationally despite being headquartered in the region. Community foundations and place-based funders such as the New York Community Trust or Boston Foundation fund only within their service area. Always verify geographic eligibility on the foundation's grants page before drafting an LOI."
  - question: "How long does the typical foundation grant cycle take from LOI to decision?"
    answer: "For invitation-only national foundations, the timeline from first contact to funded award commonly runs 9-18 months. For regional and community foundations with published cycles, expect 4-9 months from LOI submission to notification. Plan grant calendars with this lead time built in - proposals submitted in the same fiscal quarter you need the funds will rarely close in time."
  - question: "What documentation should be ready before applying?"
    answer: "Standard documentation includes: IRS 501(c)(3) determination letter, most recent 990, audited financial statements (last two years), current operating budget, project budget, board roster with affiliations, organizational logic model or theory of change, and a list of current and pending funders. Foundations with web-based application portals will also ask for narrative responses to standardized questions - drafting these once and adapting per funder cuts substantial time."
  - question: "How should a nonprofit track multiple concurrent foundation grants?"
    answer: "A grants management system with restricted fund accounting, deadline calendars, and expenditure documentation per award is the operational baseline. Spreadsheets work for organizations with one or two grants but break down at three or more concurrent awards because reconciling restricted balances across funders, programs, and fiscal periods becomes manual and error-prone. GrantPipe is built for this multi-funder workflow at the $500K-$10M budget range."
pricingStats:
  - stat: "US foundations gave $103.53 billion to nonprofits in 2023, the most recent year with full data"
    source: "Giving USA 2024"
    sourceUrl: "https://givingusa.org"
  - stat: "Approximately 86,000 grantmaking foundations are active in the United States"
    source: "Candid (formerly Foundation Center)"
    sourceUrl: "https://candid.org"
  - stat: "Foundation giving represented 19% of total US charitable giving in 2023"
    source: "Giving USA 2024"
    sourceUrl: "https://givingusa.org"
definitions:
  - term: "Letter of Inquiry (LOI)"
    definition: "A short pre-application document - typically one to three pages - describing the organization, project, and request. Foundations use LOIs to screen for fit before inviting a full proposal."
  - term: "Restricted grant"
    definition: "A grant whose use is limited by the funder to a specific program, project, or expense category. Restricted grants must be tracked separately on the balance sheet under FASB ASC 958 and cannot be redirected without funder approval."
  - term: "General operating support (GOS)"
    definition: "Unrestricted grant funding that can be used for any organizational purpose. GOS is the most flexible form of foundation funding and the most competitive - most foundations restrict the majority of their giving to specific projects or programs."
  - term: "Site visit"
    definition: "A meeting between foundation program staff and grantee leadership, usually at the grantee's offices or program site. Common in the late stage of a competitive review and often a strong positive signal - but not a guarantee of funding."
expertQuotes:
  - quote: "Build the regional grants calendar twelve months out. The organizations that consistently win foundation awards in the New England are not the ones with the best stories - they are the ones with the best calendars."
    personName: "Anonymous practitioner"
    jobTitle: "Development Director"
  - quote: "Restricted fund tracking is where audit risk concentrates. The work to keep multi-funder accounting clean is invisible until the audit, and then it is the only thing that matters."
    personName: "Anonymous practitioner"
    jobTitle: "Nonprofit Finance Director"
relatedPages:
  - "/resources/guides/grant-management-software-for-nonprofits"
  - "/resources/best/best-grant-management-software"
  - "/resources/best/best-grant-compliance-software"
  - "/resources/guides/grant-compliance-101-for-nonprofits"
  - "/resources/guides/accounting-for-restricted-funds-in-nonprofit"
sourceUrls:
  - "https://www.tbf.org"
  - "https://www.cummingsfoundation.org"
  - "https://www.klarmanfoundation.org"
  - "https://www.barrfoundation.org"
  - "https://www.libertymutualgroup.com/about-lm/corporate-information/charitable-giving"
...
**URL:** [https://www.tbf.org](https://www.tbf.org)
...
**URL:** [https://www.cummingsfoundation.org](https://www.cummingsfoundation.org)
...
**URL:** [https://www.klarmanfoundation.org](https://www.klarmanfoundation.org)
...
**URL:** [https://www.barrfoundation.org](https://www.barrfoundation.org)
...
**URL:** [https://www.libertymutualgroup.com/about-lm/corporate-information/charitable-giving](https://www.libertymutualgroup.com/about-lm/corporate-information/charitable-giving)
...
**URL:** [https://www.nycommunitytrust.org](https://www.nycommunitytrust.org)
...
**URL:** [https://www.carnegie.org](https://www.carnegie.org)
...
**URL:** [https://www.fordfoundation.org](https://www.fordfoundation.org)
...
**URL:** [https://www.rockefellerfoundation.org](https://www.rockefellerfoundation.org)
...
**URL:** [https://www.pewtrusts.org](https://www.pewtrusts.org)
...
| -------------------------------- | ---------------------------------------------------------------------------- | ------------------------------------- | --------------------------------- |
| The Boston Foundation            | Greater Boston                                                               | $10,000-$250,000                      | Open Door grants twice per year   |
| Cummings Foundation              | Greater Boston                                                               | $100,000-$500,000 over multiple years | Annual cycle, LOI in early year   |
| Klarman Family Foundation        | Boston Jewish community, biomedical research, mental health, education       | $50,000-$1,000,000                    | By invitation only                |
| Barr Foundation                  | New England                                                                  | $50,000-$500,000                      | By invitation                     |
| Liberty Mutual Foundation        | Homelessness, education, youth services in MA and Northeast                  | $10,000-$100,000                      | Rolling                           |
