...
description: "Answers for Raleigh nonprofits comparing grant management, restricted fund tracking, local funders, public contracts, and audit readiness."
seoTitle: "Raleigh nonprofit grants and compliance FAQ"
seoDescription: "Answers for Raleigh nonprofits comparing grant management, restricted fund tracking, local funders, public contracts, and audit readiness."
targetKeyword: "raleigh nonprofit compliance faq"
...
schema: "FAQPage"
bluf: "Raleigh nonprofits need the same answer in two places: what funding can we pursue, and what records must we keep if we win it."
relatedPages:
  - "/nonprofit-software/north-carolina/raleigh"
...
tags:
  ...
  - "faq"
faqs:
  - q: "Where do Raleigh nonprofits find grants?"
    a: "Start with Triangle Community Foundation, United Way of the Greater Triangle, City of Raleigh Housing and Neighborhoods, John Rex Endowment, North Carolina Community Foundation, then add city, county, state, and federal pass-through programs that match the service line."
  - q: "What records should a Raleigh nonprofit keep for every grant?"
    a: "Keep the agreement, approved budget, restriction, reporting schedule, expense support, program evidence, amendments, funder messages, and submission receipt."
  - q: "Does North Carolina Secretary of State matter for grant applications?"
    a: "Yes. Good-standing and charitable-registration status can be part of funder diligence in North Carolina, especially for larger awards or public contracts."
  - q: "When do Uniform Guidance rules apply?"
    a: "They apply to direct federal awards and many pass-through awards from state or local agencies. The award terms and assistance listing control the file."
  - q: "What software should a mid-sized nonprofit use?"
    a: "Use a system that ties donor records, funder records, restricted funds, deadlines, and audit evidence together. A CRM alone usually cannot do the post-award work."
answers:
  - q: "Where do Raleigh nonprofits find grants?"
    a: "Start with Triangle Community Foundation, United Way of the Greater Triangle, City of Raleigh Housing and Neighborhoods, John Rex Endowment, North Carolina Community Foundation, then add city, county, state, and federal pass-through programs that match the service line."
  - q: "What records should a Raleigh nonprofit keep for every grant?"
  ...
  - q: "What software should a mid-sized nonprofit use?"
    a: "Use a system that ties donor records, funder records, restricted funds, deadlines, and audit evidence together. A CRM alone usually cannot do the post-award work."
pricingStats:
  - stat: "Raleigh nonprofits should screen at least five local funding channels before building an annual grants calendar: Triangle Community Foundation, United Way of the Greater Triangle, City of Raleigh Housing and Neighborhoods, John Rex Endowment, North Carolina Community Foundation."
...
## Raleigh nonprofit grants and compliance FAQ

These questions come up when a Raleigh nonprofit moves from occasional grants to a real portfolio. The work changes once several funders expect different reports for the same program period.

### Where do Raleigh nonprofits find grants?

Start with Triangle Community Foundation, United Way of the Greater Triangle, City of Raleigh Housing and Neighborhoods, John Rex Endowment, North Carolina Community Foundation, then add city, county, state, and federal pass-through programs that match the service line.

### What records should a Raleigh nonprofit keep for every grant?
...
### Does North Carolina Secretary of State matter for grant applications?

Yes. Good-standing and charitable-registration status can be part of funder diligence in North Carolina, especially for larger awards or public contracts.
...
For workflow depth, use the [grant compliance 101 guide](/resources/guides/grant-compliance-101-for-nonprofits). For local software fit, start with [Raleigh nonprofit software](/nonprofit-software/north-carolina/raleigh).
