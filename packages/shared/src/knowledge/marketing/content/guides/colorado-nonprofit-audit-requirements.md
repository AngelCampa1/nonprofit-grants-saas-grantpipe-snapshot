...
description: "Colorado's nonprofit audit threshold, statute, deadlines, and how it interacts with the federal Single Audit"
seoTitle: "Colorado Nonprofit Audit Requirements 2026"
seoDescription: "Colorado nonprofit audit threshold (Colorado does not impose a CPA-audit threshold under the Charitable Solicitations Act; the state requires registration."
targetKeyword: "colorado nonprofit audit requirements"
...
bluf: "Colorado requires an independent CPA audit when a charitable organization's qualifying revenue exceeds Colorado does not impose a CPA-audit threshold under the Charitable Solicitations Act; the state requires registration and IRS Form 990 disclosure at all revenue levels., with secondary review and compilation tiers below that threshold. The requirement is administered by the Colorado Secretary of State under C.R.S. § 6-16-104 and operates independently of the federal Single Audit at $1,000,000 in expenditures of federal awards. Most noncompliance findings come from missed deadlines or revenue misclassification, not from the audit itself."
faqs:
  - q: "When does Colorado require a nonprofit to have an independent audit?"
    a: "Colorado requires an independent audit performed by a CPA when a registered charitable organization's qualifying revenue exceeds Colorado does not impose a CPA-audit threshold under the Charitable Solicitations Act; the state requires registration and IRS Form 990 disclosure at all revenue levels.. Below that, a CPA review is generally acceptable in the Not statutorily required range, and below the review tier (Not statutorily required) the state typically accepts a compiled or internally prepared financial package together with the IRS Form 990. Verify the current threshold with the Colorado Secretary of State before relying on any published summary - thresholds and revenue definitions are revised periodically."
  - q: "Who enforces Colorado's nonprofit audit rules?"
    a: "The Colorado Secretary of State administers Colorado's charitable registration and audit-threshold requirements. The agency has authority to investigate complaints, suspend registration for noncompliance, and assess late-filing penalties. Statutory authority comes from C.R.S. § 6-16-104."
  - q: "How does the Colorado threshold interact with the federal Single Audit?"
    a: "They run on parallel tracks. The federal Single Audit under 2 CFR Part 200 is triggered by $1,000,000 or more in expenditures of federal awards in a fiscal year. Colorado's threshold is based on contributions or revenue, not federal expenditures. A Colorado nonprofit can owe a state-required audit, a federal Single Audit, both, or neither - and a single audit engagement can usually satisfy both when scoped properly. Our [Single Audit Prep Timeline](/free/single-audit-prep-timeline) maps the parallel deadlines."
  - q: "What does the Colorado audit need to include?"
  ...
  - q: "What happens if a Colorado nonprofit misses the audit deadline?"
    a: "The Colorado Secretary of State can suspend or revoke charitable solicitation registration, refer the matter for civil penalties, and publicly flag the organization on its registry. Practical consequences usually arrive faster: foundation grant officers and government grantors check state registration status before renewing awards, and a lapsed registration is often discovered during a routine grant compliance review."
relatedPages:
  - "/resources/guides/nonprofit-audit-requirements-by-state"
  - "/nonprofit-software/colorado"
  - "/resources/guides/colorado-nonprofit-startup-guide"
...
sourceUrls:
  - "https://www.coloradosos.gov/CCSA/CharitiesHome.do"
  - "https://leg.colorado.gov/sites/default/files/images/olls/crs2023-title-06.pdf"
statistics:
  - stat: "Colorado lists more than 11,000 active charity registrations on its public TS&CS portal."
    source: "Colorado Colorado Secretary of State"
    sourceUrl: "https://www.coloradosos.gov/CCSA/CharitiesHome.do"
...
1. **Below the Colorado threshold and below $1,000,000 federal:** no audit required by either rule.
2. **Above the Colorado audit threshold (Colorado does not impose a CPA-audit threshold under the Charitable Solicitations Act; the state requires registration and IRS Form 990 disclosure at all revenue levels.) but below $1,000,000 federal:** state audit only.
3. **Below Colorado threshold but above $1,000,000 federal:** Single Audit only.
