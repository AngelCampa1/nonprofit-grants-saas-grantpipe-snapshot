...
description: "Fort Worth nonprofit grants: local funder and public program guide for teams managing foundation grants, local public programs, and federal pass-through requirements."
seoTitle: "Fort Worth nonprofit grants and public programs"
seoDescription: "Fort Worth nonprofit grants: local funder and public program guide for teams managing foundation grants, local public programs, and federal pass-through."
targetKeyword: "fort worth nonprofit grants"
...
schema: "Article"
bluf: "Fort Worth nonprofits should qualify funders by recent giving, geography, grant size, and reporting burden before drafting LOIs."
relatedPages:
  - "/nonprofit-software/texas/fort-worth"
...
tags:
  ...
  - "funding"
answers:
  - q: "Where should Fort Worth nonprofits look for grants first?"
    a: "Start with North Texas Community Foundation, United Way of Tarrant County, Amon G. Carter Foundation, Sid W. Richardson Foundation, City of Fort Worth Neighborhood Services and the relevant Fort Worth, Tarrant County, and Texas public grant portals."
...
faqs:
  - q: "Which Fort Worth funders belong on a first-pass prospect list?"
    a: "North Texas Community Foundation, United Way of Tarrant County, Amon G. Carter Foundation, Sid W. Richardson Foundation, City of Fort Worth Neighborhood Services"
  - q: "Does Texas Comptroller and Secretary of State affect grant readiness?"
...
statistics:
  ...
  - stat: "Fort Worth grant prospecting should separate open application funders from invitation-only or relationship-led funders before staff begin drafting."
    source: "GrantPipe city content research"
    sourceUrl: "https://projects.propublica.org/nonprofits/"
tableData:
  name: "Fort Worth grant workflow checklist"
...
Fort Worth teams lose time when every opportunity enters the pipeline as "possible grant." Separate the list first. Public programs need eligibility, procurement, and reporting review. Community foundations need geographic and donor-advised fund context. Private foundations need recent 990-PF giving history and a realistic grant-size match.

The local shortlist starts with North Texas Community Foundation, United Way of Tarrant County, Amon G. Carter Foundation, Sid W. Richardson Foundation, City of Fort Worth Neighborhood Services. Add Fort Worth, Tarrant County, and Texas programs only after you know which staff member can own the compliance file after award. The grant you cannot administer is not really a funding opportunity.
