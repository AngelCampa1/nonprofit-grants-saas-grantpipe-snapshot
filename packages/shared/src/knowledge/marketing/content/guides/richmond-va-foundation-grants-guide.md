...
description: "Richmond nonprofit grants: local funder and public program guide for teams managing foundation grants, local public programs, and federal pass-through requirements."
seoTitle: "Richmond nonprofit grants and public programs"
seoDescription: "Richmond nonprofit grants: local funder and public program guide for teams managing foundation grants, local public programs, and federal pass-through."
targetKeyword: "richmond nonprofit grants"
...
schema: "Article"
bluf: "Richmond nonprofits should qualify funders by recent giving, geography, grant size, and reporting burden before drafting LOIs."
relatedPages:
...
tags:
  ...
  - "funding"
answers:
  - q: "Where should Richmond nonprofits look for grants first?"
    a: "Start with Community Foundation for a greater Richmond, United Way of Greater Richmond and Petersburg, City of Richmond Department of Housing and Community Development, Robins Foundation, Virginia Health Care Foundation and the relevant Richmond, Richmond, and Virginia public grant portals."
...
faqs:
  - q: "Which Richmond funders belong on a first-pass prospect list?"
    a: "Community Foundation for a greater Richmond, United Way of Greater Richmond and Petersburg, City of Richmond Department of Housing and Community Development, Robins Foundation, Virginia Health Care Foundation"
...
statistics:
  ...
  - stat: "Richmond grant prospecting should separate open application funders from invitation-only or relationship-led funders before staff begin drafting."
    source: "GrantPipe city content research"
    sourceUrl: "https://projects.propublica.org/nonprofits/"
tableData:
  name: "Richmond grant workflow checklist"
...
Richmond teams lose time when every opportunity enters the pipeline as "possible grant." Separate the list first. Public programs need eligibility, procurement, and reporting review. Community foundations need geographic and donor-advised fund context. Private foundations need recent 990-PF giving history and a realistic grant-size match.

The local shortlist starts with Community Foundation for a greater Richmond, United Way of Greater Richmond and Petersburg, City of Richmond Department of Housing and Community Development, Robins Foundation, Virginia Health Care Foundation. Add Richmond, Richmond, and Virginia programs only after you know which staff member can own the compliance file after award. The grant you cannot administer is not really a funding opportunity.
