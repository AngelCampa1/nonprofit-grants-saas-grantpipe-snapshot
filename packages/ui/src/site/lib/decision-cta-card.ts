import type { CtaAnalyticsContext, CtaLinkConfig, DecisionCtaCardProps } from "../types";
...
export function buildDecisionCtaCardModel(props: DecisionCtaCardProps): DecisionCtaCardModel {
  return {
