 ...
 */
export function buildComparisonTableSchema(opts: ComparisonTableOpts): JsonLdSchema {
...
export function buildProsConsReviewSchema(opts: ProsConsReviewOpts): JsonLdSchema {
